...
import com.pwc.agro.sentinal.service.PriceService;
...
public class PriceController {
    ...
    public JSONObject findByCountryAndFood(@RequestParam(name = "food_type", required = false)String food_type,
        ...
        return priceService.findByCountryAndFood(food_type, country);
    }
}
